(function(define, undefined) {
    ...
    define([
        ...
        currentTheme + 'js/student_account/views/account_section_view',
        'text!' + currentTheme + 'templates/student_account/account_settings.underscore'
            ...
            accountSettingsTabs: [
                {
                    ...
                    id: 'about-tab',
                    label: gettext('Basic Account Information'),
                    class: 'active',
                    tabindex: 0,
                    selected: true,
                    expanded: true
