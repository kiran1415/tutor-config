  ...
  _createClass(PasswordResetConfirmation, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
        'div',
        { id: 'password-reset-confirm-anchor', className: 'form-type landing-wrap-max' },
        __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
          'form',
          { id: 'passwordreset-form login', className: 'login-form', method: 'post', action: '' },
          __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
            'h2',
            { className: 'section-title lines content-title' },
            __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
              'span',
              { className: 'text' },
          ...
          __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon_static__["Button"], {
            type: 'submit',
            className: ['action', 'action-primary', 'action-update', 'js-reset', 'btn', 'btn-theme', 'text-capitalize'],
