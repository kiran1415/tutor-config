        ...
        function(
            ...
            // These are reset to true on form submission.
                ...
                buildForm: function(data) {
                    ...
                    $('.required-fields select').addClass('form-control')
                ...
                render: function(html) {
                    var fields = html || '',
                        ...
                        //var position = 2372;
                        //fields = fields.substr(0, position) + "</br>The Full name that is used for ID verification and that \
                        //appears on your certificates.</br><br>The public username must be unique.</br>" + fields.substr(position);
                ...
                postRender: function() {
                    ...
                    $('#toggle_optional_fields').change(function() {
                        ...
                        $('.optional-fields select').addClass('form-control')
                        $('.optional-fields textarea').addClass('form-control')
                    });
