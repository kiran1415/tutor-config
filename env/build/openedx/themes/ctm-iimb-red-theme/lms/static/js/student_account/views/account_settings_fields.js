(function(define, undefined) {
    ...
    define([
        ...
        'underscore',
        'backbone',
        currentTheme + 'js/views/fields',
        // 'text!' + currentTheme + 'templates/fields/field_text_account.underscore',
        'text!' + currentTheme + 'templates/fields/field_text_account_name.underscore',
        'text!' + currentTheme + 'templates/fields/field_text_account_email.underscore',
        'text!' + currentTheme + 'templates/fields/field_readonly_account.underscore',
        'text!' + currentTheme + 'templates/fields/field_link_account.underscore',
        'text!' + currentTheme + 'templates/fields/field_dropdown_account.underscore',
        ...
        field_text_account_name,
        field_text_account_email,
